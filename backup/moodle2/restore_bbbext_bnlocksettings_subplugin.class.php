 ...
 */
class restore_bbbext_bnlocksettings_subplugin extends restore_subplugin {
    /**
    ...
    protected function define_bigbluebuttonbn_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/bbbext_bnlocksettings');
     ...
     * @param mixed $data
     */
    public function process_bbbext_bnlocksettings_bigbluebuttonbn($data) {
        global $DB;

        $data = (object) $data;
        $data->bigbluebuttonbnid = $this->get_new_parentid('bigbluebuttonbn');
        $DB->insert_record('bbbext_bnlocksettings', $data);
    }
}
