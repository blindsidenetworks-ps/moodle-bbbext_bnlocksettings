 ...
 */
class backup_bbbext_bnlocksettings_subplugin extends backup_subplugin {
    ...
    protected function define_bigbluebuttonbn_subplugin_structure() {
        ...
        $subpluginelement = new backup_nested_element('bbbext_bnlocksettings',
            null,
            ['enablecam', 'enableprivatechat', 'enablepublicchat', 'enablenote', 'enableuserlist']);
        // Connect XML elements into the tree.
        $subplugin->add_child($subpluginwrapper);
        $subpluginwrapper->add_child($subpluginelement);

        // Set source to populate the data.
        $subpluginelement->set_source_table('bbbext_bnlocksettings',
